...
export function loadConfig(): AppConfig {
  ...
  return {
    ...
    ga4: {
      propertyId: readOptionalString("GA4_PROPERTY_ID"),
      serviceAccountJson: readOptionalString("GA4_SERVICE_ACCOUNT_JSON"),
      configured: Boolean(
        readOptionalString("GA4_PROPERTY_ID") && readOptionalString("GA4_SERVICE_ACCOUNT_JSON")
      )
    },
    mailchimp: {
